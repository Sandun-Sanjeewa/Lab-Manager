...
import { updateMouse } from "../../../services/equipment/mouseServices";

const EditeMouse = ({ mouse, onClose, onMouseUpdated }) => {
    const { labs } = useLabs();
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await updateMouse(mouse._id,mouseData);
            setMouseData({
                mouseID: "",
                lab: "",
            ...
            if (onMouseUpdated) onMouseUpdated();
