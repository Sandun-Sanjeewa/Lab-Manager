...
import { updateLap } from "../../../services/equipment/lapServices";

const EditLap = ({lap, onClose, onLapUpdated }) => {
    const { labs } = useLabs();
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await updateLap(lap._id,lapData);
            setLapData({
                lapID: "",
                lab: "",
            ...
            if (onLapUpdated) onLapUpdated();
            toast.success("Lap updated Successfully!");
            onClose();
