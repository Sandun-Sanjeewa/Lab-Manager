...
import { createCable } from "../../../services/equipment/cableServices";
import { toast } from "react-toastify";

const CreateCable = ({ onClose, onCableCreated }) => {
    const { labs } = useLabs();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (onCableCreated) onCableCreated();
            ...
            setError((prev) => ({
                ...prev,
                general: error.response?.data?.error || "cable creating failed"
            }));
        }
    };
    return (
